...
Revision ID: 0001
Revises:
Create Date: 2026-09-21 11:37:44.726517
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_properties_market_id", "properties", ["market_id"], unique=False
    )
    op.create_table(
        "underwritings",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_underwritings_market_id"), "underwritings", ["market_id"], unique=False
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_underwritings_market_id"), table_name="underwritings")
    op.drop_table("underwritings")
    op.drop_index("ix_properties_market_id", table_name="properties")
